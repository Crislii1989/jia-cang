  ...
  group('UpdateService.parseGitHubRelease', () {
    test('解析完整 GitHub Release JSON', () {
      final json = {
        ...
        'body': '## 新功能\n1. 新增收纳统计\n2. 修复若干 bug',
        'html_url':
            'https://github.com/Crislii1989/jia-cang/releases/tag/v1.2.0',
        'assets': [
          {
            'name': 'app-arm64-v8a-release.apk',
            'browser_download_url':
                'https://github.com/Crislii1989/jia-cang/releases/download/v1.2.0/app-arm64-v8a-release.apk',
          },
          {
            'name': 'app-armeabi-v7a-release.apk',
            'browser_download_url':
                'https://github.com/Crislii1989/jia-cang/releases/download/v1.2.0/app-armeabi-v7a-release.apk',
          },
        ],
      };
  ...
  group('UpdateService.check - 网络异常场景', () {
    test('check 方法存在且返回 CheckUpdateOutcome', () async {
      ...
      expect(
        ...
        'https://api.github.com/repos/Crislii1989/jia-cang/releases/latest',
      );
      expect(
        UpdateService.githubReleasesUrl,
        'https://github.com/Crislii1989/jia-cang/releases',
      );
    });
  });
