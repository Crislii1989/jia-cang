...
- category：物品大类，必须严格从以下选项中选择最合适的一个（必须使用原词，禁止改写、扩展或添加任何后缀）：
  "数码电子"、"家电"、"衣物鞋包"、"个人洗护"、"餐厨用品"、"家居生活"、"运动户外"、"书籍"、"文具办公"、"玩具兴趣"、"工具五金"、"饰品贵重"、"家居装饰"、"其他"
...
分类选择指南：
- 数码电子：手机、电脑、耳机、相机、充电器、数据线等电子产品及配件
- 家电：电视、冰箱、洗衣机、吸尘器、电饭煲等家用电器
- 衣物鞋包：衣服、裤子、鞋子、帽子、箱包等穿戴用品
- 个人洗护：精华、面霜、乳液、化妆品、洗浴用品等个人护理美妆用品
- 餐厨用品：锅具、餐具、刀具、烹饪用具等厨房用餐物品
- 家居生活：收纳箱、整理架、衣架、日化清洁、纸品等日常家居用品
- 运动户外：健身器材、球类、运动护具、露营徒步装备等运动用品
- 书籍：图书、杂志、音像制品等
- 文具办公：笔、本、尺、剪刀、胶带、订书机等文具办公用品
- 玩具兴趣：玩偶、积木、模型、桌游、乐器等玩具兴趣爱好物品
- 工具五金：螺丝刀、锤子、扳手、量具等工具
- 饰品贵重：首饰、手表、珠宝、收藏品等贵重小件
- 家居装饰：摆件、挂画、花瓶、香薰等装饰物品
- 其他：无法明确归入以上分类的物品

只返回 JSON，例如：
{"name":"白色陶瓷马克杯","category":"餐厨用品","brand":"","color":"白色","material":"陶瓷","features":"圆柱形杯身，带蓝色把手","description":"简约白色陶瓷马克杯，带蓝色把手","condition":"九成新","suggestedTags":["日常用品","饮水器具"]}
''';
